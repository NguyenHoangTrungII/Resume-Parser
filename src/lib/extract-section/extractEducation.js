...
import { DATE_FEATURE_SETS, hasComma, hasLetter, hasNumber } from "../common-features/common-features";
import { getTextWithHighestFeatureScore } from "../feature-scoring-system/featureScoringSystem";
import { getBulletPointsFromLines, getDescriptionsLineIdx } from "../common-features/bullte-point";

const SCHOOLS = ['College', 'University', 'Institute', 'School', 'Education', 'Academy', 'BASIS', 'Magnet', 'Trường', 'Đại Học', 'Cao Đẳng'];
const hasSchool = (item) => SCHOOLS.some((school) => item.text.toUpperCase().includes(school.toUpperCase()));
